...
class LoseWeightBeginnerScreen extends StatelessWidget {
  ...
  LoseWeightBeginnerScreen({super.key});
                      ...
                      children: [
                        Column(
                          children: [
                            ...
                            Text(l10n.beginner, style: theme.textTheme.bodyMedium?.copyWith(fontSize: 12, color: isDark ? Colors.white70 : Colors.black87)),
                          ],
                        ),
                        Column(
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(l10n.burnt60kcal, style: theme.textTheme.bodyMedium?.copyWith(fontSize: 12, color: isDark ? Colors.white70 : Colors.black87)),
                          ],
                        ),
                        Column(
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(l10n.time12to18min, style: theme.textTheme.bodyMedium?.copyWith(fontSize: 12, color: isDark ? Colors.white70 : Colors.black87)),
                          ],
                        ),
                      ],
                    ),
