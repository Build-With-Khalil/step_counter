...
class LoseWeightAdvancedScreen extends StatelessWidget {
  final List<AbsMoveModel> moves = [
    AbsMoveModel(name: 'INCHWORM', iconPath: 'assets/images/inchw.gif', reps: '18–20 reps'),
    AbsMoveModel(name: 'JUMPING JACKS', iconPath: 'assets/images/jumping_jacks.gif', reps: '60 sec × 3 sets'),
    AbsMoveModel(name: 'SPLIT JUMPS', iconPath: 'assets/images/split_jump_exercise.gif', reps: '20 reps per leg'),
    AbsMoveModel(name: 'SQUAT REACH', iconPath: 'assets/images/squat_reach_exercise.gif', reps: '40 reps'),
  ];

   LoseWeightAdvancedScreen({super.key});
                      ...
                      children: [
                        Column(
                          children: [
                            ...
                            Text(l10n.advanced, style: theme.textTheme.bodyMedium?.copyWith(fontSize: 12, color: isDark ? Colors.white70 : Colors.black87)),
                          ],
                        ),
                        Column(
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(l10n.burnt140to160kcal, style: theme.textTheme.bodyMedium?.copyWith(fontSize: 12, color: isDark ? Colors.white70 : Colors.black87)),
                          ],
                        ),
                        Column(
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(l10n.time40plusMin, style: theme.textTheme.bodyMedium?.copyWith(fontSize: 12, color: isDark ? Colors.white70 : Colors.black87)),
                          ],
                        ),
                      ],
                    ),
